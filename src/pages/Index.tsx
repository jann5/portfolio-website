...
const CursorFollower = () => {
  ...
  return (
    <motion.div
      className="fixed top-0 left-0 w-14 h-14 pointer-events-none z-[9999] hidden lg:block rounded-full overflow-hidden"
      style={{
        x: cursorX,
        y: cursorY,
        backgroundImage: "url('/cHJpdmF0ZS9sci9pbWFnZXMvd2Vic2l0ZS8yMDIyLTEyL3JtNjAxLWUtMDg1LXAucG5n.jpeg')",
